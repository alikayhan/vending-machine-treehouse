...
//  VendingMachine
//
//  Created by Ali Kayhan on 22/02/16.
...
// let c = PlistConverter()     // If the method above were an instance method, we would call it in this way.
// c.someMethod()

// PlistConverter.someMethod()  // Since the method above is a type method, we can call it in this way.
                                // Of course, not in global scope.
...
class VendingMachine: VendingMachineType {
    ...
    // Since init is a required method due to protocol, we add 'required' keyword.
    required init(inventory: [VendingSelection : ItemType]) {
        self.inventory = inventory
        
        // VendingSelection(rawValue: <#T##String#>)
    }
